...
if __name__ == '__main__':
    ...
    parser.add_argument('task', choices=['object', 'action', 'relation'], default= 'action',
                        help='which task the groundtruth generated for')
    parser.add_argument('output', type=str, help='Output path', default='output/vidor_gt_val_object.json')
